...
burger.addEventListener("click", () => {
    menu.classList.add("header__menu_activite");
    document.body.style.overflow = "hidden";
});

close.addEventListener("click", () => {
    menu.classList.remove("header__menu_activite");
...
try {
    const cards = document.querySelectorAll(".catalog__content-img");

    cards.forEach(card => {
        card.addEventListener("click", () => {

            // oldingi active ni olib tashlash
            cards.forEach(item => {
                item.classList.remove("active");
            });

            // bosilgan cardga active qo'shish
...
try {
    const cards = document.querySelectorAll(".blog__wrapper");
